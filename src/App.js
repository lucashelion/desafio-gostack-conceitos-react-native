...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    const repositorieUpdated = repositories.map(repo => repo.id === id 
      ? repoUpdated 
      : repo);
          ...
          renderItem={({ item: repositorie }) => (
            <View style={styles.repositoryContainer}>
              ...
              <View style={styles.techsContainer}>
                {repositorie.techs.map(tech => <Text key={tech} style={styles.tech}>{tech}</Text>)}
              </View>
              <View style={styles.likesContainer}>
                <Text style={styles.likeText} testID={'repository-likes-' + repositorie.id}>
